      ...
      <div className="flex flex-col lg:flex-row mt-8 gap-6">                
        ...
        <section className="w-full lg:w-1/3 lg-6 lg:mt-0 sm:flex sm:items-center sm:justify-center lg:block">
          <div className='flex flex-col bg-babygreen rounded-lg p-12 sm:w-2/4 lg:w-full'>
            ...
            <Link href="/LogIn" aria-label='Click to go to Log in page' className='p-2 mt-4 border border-primaryGreen font-bold text-2xl bg-white rounded-lg text-primaryGreen hover:bg-primaryGreenDarker hover:text-white drop-shadow-md active:drop-shadow-2xl text-center'>Log In</Link>
            <Link href="/SignUp" aria-label='Click to go to the Sign up page' className='p-2 mt-4 border border-primaryGreen font-bold text-2xl bg-white rounded-lg text-primaryGreen hover:bg-primaryGreenDarker hover:text-white drop-shadow-md active:drop-shadow-2xl text-center'>Sign Up</Link>
          </div>
        </section>
      </div>
    </main>
